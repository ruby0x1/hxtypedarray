...
import haxe.io.buffer.Float32Array;
...
class TestFloat32Array extends mohxa.Mohxa {
    ...
    public function new() {
        ...
        describe('Float32Array test02', function(){
            ...
            var x = Float32Array.fromArray([17, -45.3]);
        ...
        describe('Float32Array test03', function(){
            ...
            var x = Float32Array.fromArray([17, -45.3]);
            var y = Float32Array.fromBuffer(x.buffer);
        ...
        describe('Float32Array test04', function(){
            ...
            var x = Float32Array.fromArray([17, -45.3]);
            var y = Float32Array.fromTypedArray(x);
        ...
        describe('Float32Array test05', function(){
            ...
            var x = Float32Array.fromBuffer(buffer, 0, 2);
            var y = Float32Array.fromBuffer(buffer, 4, 1);
        ...
        describe('Float32Array test07', function(){
            ...
            x.set(Float32Array.fromArray([18, 93, 42]), 3);
        ...
        describe('Float32Array test08', function(){
            ...
            var x = Float32Array.fromArray([0, 1, 2, 3, 4, 5]);
