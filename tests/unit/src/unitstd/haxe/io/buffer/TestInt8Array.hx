...
import haxe.io.buffer.Int8Array;
...
class TestInt8Array extends mohxa.Mohxa {
    ...
    public function new() {
        ...
        describe('Int8Array test02', function(){
            ...
            var x = Int8Array.fromArray([17, -45]);
        ...
        describe('Int8Array test03', function(){
            ...
            var x = Int8Array.fromArray([17, -45]);
            var y = Int8Array.fromBuffer(x.buffer);
        ...
        describe('Int8Array test04', function(){
            ...
            var x = Int8Array.fromArray([17, -45]);
            var y = Int8Array.fromTypedArray(x);
        ...
        describe('Int8Array test05', function(){
            ...
            var x = Int8Array.fromBuffer(buffer, 0, 6);
            var y = Int8Array.fromBuffer(buffer, 4, 1);
        ...
        describe('Int8Array test07', function(){
            ...
            x.set(Int8Array.fromArray([18, 93, 42]), 3);
        ...
        describe('Int8Array test08', function(){
            ...
            var x = Int8Array.fromArray([0, 1, 2, 3, 4, 5]);
