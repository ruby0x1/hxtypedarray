...
import haxe.io.buffer.Int16Array;
...
class TestInt16Array extends mohxa.Mohxa {
    ...
    public function new() {
        ...
        describe('Int16Array test02', function(){
            ...
            var x = Int16Array.fromArray([17, -45]);
        ...
        describe('Int16Array test03', function(){
            ...
            var x = Int16Array.fromArray([17, -45]);
            var y = Int16Array.fromBuffer(x.buffer);
        ...
        describe('Int16Array test04', function(){
            ...
            var x = Int16Array.fromArray([17, -45]);
            var y = Int16Array.fromTypedArray(x);
        ...
        describe('Int16Array test05', function(){
            ...
            var x = Int16Array.fromBuffer(buffer, 0, 6);
            var y = Int16Array.fromBuffer(buffer, 4, 1);
        ...
        describe('Int16Array test07', function(){
            ...
            log('calling set(Int16Array.fromArray([18, 93, 42]), 3)');

            x.set(Int16Array.fromArray([18, 93, 42]), 3);
        ...
        describe('Int16Array test08', function(){
            ...
            var x = Int16Array.fromArray([0, 1, 2, 3, 4, 5]);
